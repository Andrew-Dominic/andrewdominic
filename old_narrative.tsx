...
/* ΓöÇΓöÇ Scroll-reveal text: words fade from dim ΓåÆ full as you scroll ΓöÇΓöÇ */
  ...
  return (
    <section id="about" ref={containerRef} className="bg-grit-900 text-white relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* ΓöÇΓöÇ Block 1: Headline ΓÇö Full viewport, single focus ΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇ Block 2: Who I am ΓÇö scroll-reveal ΓöÇΓöÇ */}
        <div className="min-h-[70vh] flex items-center px-8 md:px-16 py-24">
          <div className="max-w-3xl">
            <RevealText className="text-xl md:text-2xl lg:text-3xl font-body font-light text-white leading-[1.6] tracking-tight">
              I'm Andrew Dominic M ΓÇö a 19-year-old CS and Business Systems student at RIT Chennai, and co-founder of Synflow Studio, a web and AI automation agency based in Chennai.
            </RevealText>
          </div>
        </div>

        {/* ΓöÇΓöÇ Block 3: What I build ΓÇö scroll-reveal ΓöÇΓöÇ */}
        <div className="min-h-[70vh] flex items-center px-8 md:px-16 py-24">
          <div className="max-w-3xl">
            <RevealText className="text-xl md:text-2xl lg:text-3xl font-body font-light text-white leading-[1.6] tracking-tight">
              I build systems for real businesses ΓÇö not demo apps, not clones. IΓÇÖve shipped a production e-commerce platform for a 100K audience brand, a live ticketing system for a 3,000+ attendee college fest, and an autonomous drone dashboard for the ISRO challenge.
            </RevealText>
          </div>
        </div>

        {/* ΓöÇΓöÇ Block 4: Pull Quote ΓÇö Full screen, dramatic ΓöÇΓöÇ */}
        <div className="min-h-screen flex items-center justify-center px-8 md:px-16 py-24">
          <div className="max-w-4xl text-center">
            ...
            <div className="mt-12 flex items-center justify-center gap-3">
              ...
              <span className="text-[0.5rem] font-header font-bold tracking-[0.3em] text-white/15 uppercase">THATΓÇÖS STILL WHAT DRIVES ME</span>
              <div className="h-px w-10 bg-white/15" />
            </div>
          </div>
        </div>

        {/* ΓöÇΓöÇ Block 5: Closing statement ΓÇö scroll-reveal ΓöÇΓöÇ */}
        <div className="min-h-[60vh] flex items-center px-8 md:px-16 py-24">
          <div className="max-w-3xl">
            <RevealText className="text-xl md:text-2xl lg:text-3xl font-body font-semibold text-white leading-[1.6] tracking-tight">
              When I'm not building, I'm documenting the journey on Instagram and LinkedIn ΓÇö because I think more students should see what's actually possible when you just start building.
            </RevealText>
          </div>
        </div>

        {/* ΓöÇΓöÇ Block 6: Skills ΓÇö Clean, minimal, centered ΓöÇΓöÇ */}
        <div className="px-8 md:px-16 py-24 md:py-32">
          <div className="max-w-5xl mx-auto text-center">
            <div className="h-px w-full bg-white/10 mb-16" />

            <div className="mb-14">
              <span className="text-[0.5rem] font-header font-bold tracking-[0.35em] uppercase text-white/50 block mb-6">SYSTEMS I WORK WITH</span>
            ...
            <div className="mb-14">
              <span className="text-[0.5rem] font-header font-bold tracking-[0.35em] uppercase text-white/50 block mb-6">CURRENT FOCUS</span>
              <div className="flex flex-wrap justify-center gap-x-6 gap-y-2">
            ...
            <div className="mb-14">
              <span className="text-[0.5rem] font-header font-bold tracking-[0.35em] uppercase text-white/50 block mb-6">TOOLS I USE DAILY</span>
            ...
            <div className="mt-8 flex items-center justify-center gap-4">
              ...
              <span className="text-xs font-header font-bold text-white/50 tracking-tight">B.Tech CS ├ù Business Systems ΓÇö RIT Chennai</span>
            </div>
          </div>
        </div>
