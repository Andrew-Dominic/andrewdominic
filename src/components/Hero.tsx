...
export default function Hero() {
  return (
    <section className="relative h-screen flex flex-col justify-center items-center px-6 md:px-12 overflow-hidden bg-white text-center">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        <motion.div 
          ...
          className="absolute top-[8%] left-[2%] w-48 h-64 border border-grit-900/20 bg-grit-200/10 shadow-2xl"
        >
        ...
        <motion.div 
          ...
          className="absolute top-[12%] right-[2%] w-80 h-48 border border-grit-900/20 bg-grit-200/10 shadow-2xl"
        >
        ...
        <motion.div 
          ...
          className="absolute bottom-[8%] left-[2%] w-64 h-64 border border-grit-900/20 bg-grit-200/10 shadow-2xl"
        >
        ...
        <motion.div 
          ...
          className="absolute bottom-[5%] right-[8%] w-44 h-60 border border-grit-900/20 bg-grit-200/10 shadow-2xl"
        >
      ...
      <div className="max-w-4xl mx-auto w-full relative z-10 flex flex-col items-center">
        ...
        >
          <div className="flex items-center gap-2 mb-2 md:mb-4">
            ...
            <p 
              className="font-header text-[0.5rem] md:text-[0.6rem] font-bold tracking-[0.4em] uppercase text-grit-900"
          ...
          <h1 className="relative z-10 text-4xl sm:text-6xl md:text-7xl lg:text-[6.5rem] font-poster font-bold leading-[0.85] tracking-[-0.04em] text-grit-900 mb-2 md:mb-3 max-w-3xl mx-auto flex flex-col items-center uppercase">
          ...
          <motion.div
            ...
            className="mb-4 md:mb-8 relative z-0 w-full max-w-xl mx-auto overflow-hidden h-16 md:h-24 flex items-center justify-center"
          >
            <img 
          ...
          <div className="max-w-2xl mx-auto mt-4 md:mt-8">
            <p 
              className="text-xs sm:text-sm md:text-base text-grit-900 leading-relaxed font-body font-medium mb-4 md:mb-6 max-w-xl mx-auto px-4"
              style={{ textShadow: '0 0 8px rgba(255,255,255,1), 0 0 16px rgba(255,255,255,0.9), 0 0 24px rgba(255,255,255,0.6)' }}
            >
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full sm:w-auto px-8 py-3.5 bg-grit-900 text-white font-body font-black tracking-widest text-xs uppercase flex items-center justify-center gap-3 transition-colors hover:bg-black"
              >
      ...
      <motion.div 
        ...
        className="absolute bottom-8 left-6 right-6 md:left-12 md:right-12 flex justify-between items-center text-[0.55rem] font-header font-bold tracking-[0.3em] uppercase text-grit-200"
      >
